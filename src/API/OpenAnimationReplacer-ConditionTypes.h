...
namespace Conditions
{
	...
	using ConditionComponentFactory = IConditionComponent* (*)(const char* a_name);
	...
	public:
		...
		virtual IConditionComponent* AddComponent(ConditionComponentFactory a_factory, const char* a_name) = 0;
	...
	{
	public:
		IConditionComponent(const char* a_name) :
			name(a_name)
		{}
	...
	public:
		...
		IMultiConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		IFormConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		INumericConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		INiPoint3ConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		IKeywordConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		ITextConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		IBoolConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		IComparisonConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		IRandomConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		ICustomConditionComponent(const char* a_name) :
			IConditionComponent(a_name)
		{}
	...
	public:
		...
		IConditionComponent* AddComponent(ConditionComponentFactory a_factory, const char* a_name) override { return _wrappedCondition->AddComponent(a_factory, a_name); }

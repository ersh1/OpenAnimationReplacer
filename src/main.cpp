...
{
	auto api = OAR_API::Conditions::ConditionsInterface::GetSingleton();
	...
	case OAR_API::Conditions::InterfaceVersion::V1:
		...
		return static_cast<OAR_API::Conditions::IConditionsInterface1*>(api);
	}
...
{
	auto api = OAR_API::UI::UIInterface::GetSingleton();
	...
	case OAR_API::UI::InterfaceVersion::V1:
		...
		return static_cast<OAR_API::UI::IUIInterface1*>(api);
	}
